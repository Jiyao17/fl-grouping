...
marks = ["_random_alpha0.1_gs5_5*2" ] +  ["_rcv_alpha0.1_gs5_5*2" ] + ["_srcv_alpha0.1_gs5_5*2" ] + ["_alpha0.1_cv1.0_5*2" ] 
fig_labels = ["Random", "RCoV", "SRCoV", "ESRCoV"]
...
plt.savefig("comp_s.png")
plt.savefig("comp_s.pdf")
